  ...
  <path d="M4 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0z"/>
            ...
            <div class="form-check d-flex justify-content-start mb-4">
              <input
                ...
                id="form1Example3"
              />
              <label class="form-check-label" for="form1Example3"> Jelszó megjegyzése </label>
            </div>
      ...
      let email =document.getElementById('email').value
        ...
        fetch('../server/auth.php',{method:"POST",body:formData})
            ...
            .then(data=>{
              console.log(data)
              if(!data){
                  document.querySelector('.msg').innerHTML='<div class="alert alert-danger">Nem</div>'
              }else{
            ...
            document.querySelector('.msg').innerHTML='<div class="alert alert-danger">Jelszavak nem egyeznek!</div>'
          }
    }
